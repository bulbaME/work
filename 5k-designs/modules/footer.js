...
export default function Footer() {
    return <div className='w-full p-8 py-2 bg-white text-black sm:text-base text-sm'>
        <div className='max-w-7xl m-auto flex md:flex-nowrap flex-wrap'>
            ...
            <div className='m-auto px-8 py-6 ml-0 md:w-1/3'>
            ...
            <div className='m-auto py-6 px-8 sm:ml-auto ml-0 md:w-2/5'>
                <div className='font-bold mb-2'>{"© 2023 5K Designs. All rights reserved."}</div>
                {"Crafting captivating designs that elevate your brand. Join our creative community for design trends and updates. Thank you for choosing 5K Designs as your creative partner."}
            </div>
        </div>
