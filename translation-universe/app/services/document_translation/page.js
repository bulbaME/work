...
export default function Main() {
    return <>
        ...
        <div className='max-w-4xl m-auto'>
            <Paragraph img='/img/9.jpg' title='Our Document Translation Services' text="In today's interconnected world, effective communication is paramount for businesses and individuals alike. At Translation Universe, we understand the power of words and the impact they can have on connecting cultures and driving success. Our document translation services are designed to bridge language barriers, enabling you to communicate your message accurately and seamlessly to a global audience." />
            ...
            <ParagraphL img='/img/12.jpg' title='Our Commitment to Your Documents' text="At Translation Universe, we prioritize quality, confidentiality, and timely delivery. We understand that your documents are sensitive and important, which is why we handle them with the utmost care and maintain strict data security measures. Whether you require certified translations, legal document translations, or precise technical translations, we have the expertise and resources to fulfill your requirements." />
