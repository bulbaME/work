...
export default function Main() {
    return <>
        ...
        <div className='max-w-4xl m-auto'>
            <Paragraph img='/img/2.jpg' title="Empowering Global Connections: Break Language Barriers with Translation Universe" text="At Translation Universe, we are not just translators; we are facilitators of meaningful connections. We understand that language goes beyond words—it carries emotions, ideas, and cultural nuances. Our team is passionate about breaking down language barriers and fostering understanding between diverse communities. We believe that every conversation, every document, and every interaction is an opportunity to bridge gaps and build bridges. Join us in this mission as we empower individuals, businesses, and organizations to communicate effectively and make a lasting impact in a globalized world." />
        </div>
        <div className='max-w-4xl m-auto'>
            <div className='font-bold text-4xl underline decoration-g-l m-auto w-fit p-1'>
                <a id='why-us' className='decoration-g-l'>Why choose Translation Universe?</a>
            </div>
            ...
            <div className='font-semibold text-3xl max-w-3xl m-auto p-8'>{"Take the first step towards a truly global presence. Experience the power of seamless language translation with Translation Universe."}</div>
            ...
            <div className='font-semibold text-3xl max-w-3xl my-16 m-auto p-8'>{"Start your journey with Translation Universe and embrace the power of effective communication without limits. Together, let's transcend languages and unlock new horizons."}</div>
        </div>
        <Rating />
        <Footer />
    </>;
