    ...
    return <>
        ...
        <div className='background-2 m-auto max-w-7xl'>
            <div className='max-w-7xl m-auto background-2 p-4 sm:p-[4.5rem] text-white'>
                ...
                <div className='text-xl sm:text-4xl font-medium'>{"At MayLieDesigns, we value meaningful connections. Our contact page is your gateway to explore limitless possibilities for your brand. Whether you're starting a new project or seeking design expertise, our team is here to listen, collaborate, and empower your brand's growth. Reach out to us today, and let's embark on a creative journey together. Welcome to MayLieDesigns."}</div>
            </div>
        </div>
        <div className='max-w-5xl m-auto'>
            ...
            <div className='m-auto p-5 w-full'>
                <div className='rounded-3xl h-fit overflow-hidden drop-shadow-lg border-v1-m border-8'>
                    <iframe className='w-full h-[25rem]' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2957.9444619488645!2d24.789779611789488!3d42.151475271092885!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14acd15b4483b4a5%3A0xc27d91301f49cfba!2sul.%20%22Zheravna%22%2022%2C%2020%2C%204006%20Izgrev%2C%20Plovdiv%2C%20Bulgaria!5e0!3m2!1sen!2s!4v1692259639761!5m2!1sen!2s" width="600" height="450" style={{border: 0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
