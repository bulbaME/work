...
export function FeedbackWidget() {
    return <div className='mb-24 m-auto max-w-7xl'>
        ...
        <div className='m-auto w-full p-0 sm:ml-12 flex flex-wrap my-16'>
            <FeedbackCard title='John D.' text="Thanks to Amiadagency, my online store's search engine rankings skyrocketed, resulting in a significant boost in sales. Their expertise and strategies have delivered outstanding results. Highly recommended!" />
        ...
        <div className='m-auto w-full p-0 sm:ml-12 flex flex-wrap-reverse my-16'>
            ...
            <FeedbackCard title='Sarah M.' text="Amiadagency transformed my struggling blog with their content marketing services. Engaging blog articles and improved search engine visibility have made all the difference. I'm grateful for their contribution to my blog's success." />
        </div>
        <div className='m-auto w-full p-0 sm:ml-12 flex flex-wrap my-16'>
            <FeedbackCard title='Michael S.' text="Amiadagency helped my small business dominate the local market. With optimized Google My Business listings and valuable insights, my business now appears prominently in local search results. Highly recommended for local SEO!" />
            <img className='max-h-[20rem] m-auto' src='/img/23.png' />
        </div>
        <div className='m-auto w-full p-0 sm:ml-12 flex flex-wrap-reverse my-16'>
            <img className='max-h-[20rem] m-auto' src='/img/22.png' />
            <FeedbackCard title='Emily P.' text="Amiadagency did wonders with my website's on-page optimization. Improved search engine rankings and a significant increase in organic traffic speak volumes about their professionalism and expertise." />
        </div>
    </div>;
}