...
export default function Main() {
    ...
    return <>
        ...
        <div className='max-w-4xl m-auto p-4'>
            ...
            } title='E-mail' descr='support@amiadagency.com' />
            </div>
        ...
        <div className='max-w-4xl m-auto p-4 mt-10 mb-24'>
            ...
            <form onSubmit={() => send_mail(name, mail, product, text)} className='w-full p-1 sm:p-8 bg-p-m rounded-3xl text-white h-fit'>
                ...
                <label className='m-4 flex'>
                    ...
                    <input required className='bg-white select-none appearance-none outline-none text-p-d rounded-full p-2 px-4 mr-2 w-3/5 m-auto' value={name} onChange={(e) => Setname(e.value)} />
                </label>
                <label className='m-4 flex'>
                    <div className='m-2 mr-0 text-xl'>
                        Your E-mail:
                    </div>
                    <input required className='bg-white select-none appearance-none outline-none text-p-d rounded-full p-2 px-4 mr-2 w-3/5 m-auto' value={mail} onChange={(e) => Setmail(e.value)} />
                </label>
                <label className='m-4 flex'>
                    <div className='m-2 mr-0 w-1/3 text-xl'>
                        Describe your needs:
                    </div>
                    <textarea className='bg-white select-none appearance-none outline-none text-p-d rounded-2xl sm:rounded-3xl p-2 px-4 h-[6rem] mr-2 w-3/5 m-auto resize-none' value={text} onChange={(e) => Settext(e.value)} />
                </label>
