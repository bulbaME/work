...
export default function X() {
    return <>
        ...
        <a id='story'>
            <P2L img='/img/7.png' slogan='Crafting Words, Creating Connections' title='Our Story' text={<>{"Welcome to SuccessCopywriting, where words come alive, and brands find their voice. Our journey began with a passion for the art of communication and a vision to empower businesses with persuasive storytelling. Since our inception, we've been dedicated to unlocking the true potential of brands through compelling copy."} <div className='py-4' />
                {"Our founders, Jane and Michael, recognized the transformative power of words in shaping perceptions, influencing decisions, and forging lasting connections. With backgrounds in marketing and creative writing, they combined their expertise to establish SuccessCopywriting. From the very beginning, our focus has been on creating content that not only engages but also drives results for our clients."} <div className='py-4' />
        ...
        <a id='mission'>
            <P2L img='/img/8.png' slogan='Empowering Your Success, One Word at a Time' title='Our Mission' text={<>{"At SuccessCopywriting, our mission is crystal clear: to propel your business towards success through the power of words. We believe that every brand has a unique story to tell, and we are here to bring that narrative to life. With our strategic approach, creative flair, and results-driven mindset, we aim to drive your business forward, one word at a time."} <div className='py-4' />
