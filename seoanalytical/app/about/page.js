...
export default function Main() {
    return <>
        ...
        <div className='mb-24 -mt-24 max-w-7xl m-auto'>
            <Paragraph img='/img/24.png' title='Our Mission' text="At Seoanalytical, our mission is to empower businesses with the tools and strategies they need to succeed in the ever-evolving digital landscape. We are passionate about helping our clients achieve their online goals and maximize their online presence. With our expertise in search engine optimization (SEO) and digital marketing, we strive to provide innovative solutions that drive results and deliver exceptional value to our clients." />
            <ParagraphL img='/img/25.png' title='Our Expert Team' text="Behind Seoanalytical is a team of experienced professionals who are dedicated to staying at the forefront of the SEO industry. Our team comprises SEO strategists, content creators, web developers, and digital marketing specialists who bring a wealth of knowledge and expertise to every project. We are committed to continuous learning and keeping up with the latest trends and algorithms to ensure our clients receive cutting-edge strategies and tactics that drive tangible results." />
            <Paragraph img='/img/26.png' title='Our Approach' text="At Seoanalytical, we believe in a collaborative approach that puts our clients' goals and objectives at the forefront. We begin by understanding your unique business needs, target audience, and industry landscape. Based on this knowledge, we develop customized strategies and solutions that align with your specific requirements. Throughout the process, we maintain open lines of communication, provide regular progress updates, and ensure transparency in our actions and results." />
            <ParagraphL img='/img/27.png' title="Let's Work Together" text="Are you ready to take your online presence to the next level? Partner with Seoanalytical today and discover the power of effective SEO strategies. Whether you are looking to increase website traffic, improve search engine rankings, or boost conversions, our team is ready to help you achieve your goals. Contact us for a consultation and let's embark on a journey towards online success together." />
            <div className='p-8'>
