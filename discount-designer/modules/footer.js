...
export default function Footer(props) {
    ...
    return <div className='w-full flex text-center p-4 bg-black text-white font-light'>
        ...
        { showTopBtn ? 
        <div className='fixed bg-v1-m bottom-[4rem] right-[2rem] text-white sm:p-6 p-4 rounded-full cursor-pointer drop-shadow-xl hover:bottom-[5rem] duration-300' onClick={goToTop}>
