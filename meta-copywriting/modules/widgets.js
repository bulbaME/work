...
function CFeature(props) {
    return <div className='p-4 md:w-2/5 m-auto sm:my-20 my-8'>
        <div className='flex'>
...
export function WTestimonials() {
    return <div className='sm:my-20 my-12 max-w-7xl m-auto p-2'>
        ...
        <div className='my-6 flex flex-wrap'>
            <CTestimonials name="Alex Turner, Founder" text="MetaCopywriting took our website to a whole new level. Their website copy was not only engaging and persuasive but also perfectly captured our brand's personality. Thanks to their work, our conversions have increased significantly, and we've received numerous compliments from our customers. Highly recommended!" />
            <CTestimonials name="Sarah Johnson, Marketing Manager" text="Working with MetaCopywriting was an absolute pleasure. Their team of talented copywriters crafted exceptional email campaigns that strengthened our customer relationships and boosted our sales. The results were beyond our expectations, and we are thrilled to continue collaborating with them for our future marketing endeavors." />
            <CTestimonials name="Michael Roberts, CEO" text="MetaCopywriting has been an invaluable asset to our brand. Their expertise in crafting persuasive product descriptions has significantly increased our online sales. Their copy not only communicates the unique features of our products but also connects with our customers on a personal level. We couldn't be happier with the results!" />
            <CTestimonials name="Emily Ramirez, Social Media Manager" text="We were struggling to create engaging content for our social media platforms until we found MetaCopywriting. Their social media posts were not only visually appealing but also captured the essence of our brand. Our engagement rates have soared, and our followers have multiplied since we started working with them. They truly understand what our audience wants!" />
        </div>
    </div>;
}
