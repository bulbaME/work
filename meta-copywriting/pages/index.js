...
export default function X() {
    return <>
        ...
        <div className='bg-1 pb-[40rem] sm:-mb-[28rem] -mb-[36rem]'>
            <div className='max-w-7xl m-auto p-6 pt-14'>
                <div className='flex flex-wrap py-6 pt-0'>
                    <div className='md:w-2/3'>
                        ...
                        <div className='sm:text-5xl text-3xl font-bold text-white'>
                            {"Your Partner in Copywriting Excellence MetaCopywriting"}
                        </div>
                        <div className='sm:text-2xl text-lg font-medium text-white mt-12'>
                            {"Welcome to MetaCopywriting, where we believe in the transformative power of words. As a premier copywriting company, we specialize in crafting captivating and influential content that drives results and leads you towards unparalleled success."}
                        </div>
                    </div>
