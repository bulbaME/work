...
export default function NavMenu(props) {
    ...
    return <div>
        <div className={'duration-300 ease-in-out text-p px-2 ' + (dropDown ? ' text-y':'')} onClick={() => setDropDown(!dropDown)}>
        ...
        <div className={'absolute transition-height duration-300 overflow-hidden -ml-[9.5rem] sm:mt-[1.4rem] mt-[1rem]' + (dropDown ? ' h-[30rem]':' h-0')}>
            <div className='px-4 py-1 bg-black text-p-b'>
