    ...
    return <>
        ...
        <div className='max-w-7xl m-auto background-home py-12 p-4'>
            <div className='w-fit m-auto text-4xl text-center sm:text-6xl font-bold text-white'>
                Welcome to CopywriteProfessional
            </div>
