...
export function WServicesSmall() {
    const s = services.map((v, i) => {
        return <div className='md:w-1/3 sm:w-1/2 m-auto w-full' key={i}>
            <CServicesSmall title={v.title} text={v.text_short} link={v.link} />
        </div>;
    });
...
export function WTestimonials() {
    return <div className='max-w-7xl m-auto p-2 my-12'>
        ...
        <div className='flex flex-wrap'>
            <CTestimonials name='Sarah Andrews, CEO' text="JustBelieveSeo has been an absolute game-changer for our company! Their SEO strategies have significantly improved our website's visibility, leading to a steady influx of qualified leads. Our organic traffic has soared, and we now rank at the top for several key industry keywords. The team's expertise and dedication to our success are unmatched. Thank you, JustBelieveSeo, for helping TechGenius thrive in the digital landscape!" />
            <CTestimonials name='John Lawson, Founder' text="Working with JustBelieveSeo has been an incredible experience! Their approach to SEO is strategic and tailored to our eco-friendly brand. Not only did they boost our rankings, but they also optimized our website's technical aspects, resulting in faster load times and an overall better user experience. EcoBloom's online presence has never been stronger, and we owe it all to the fantastic team at JustBelieveSeo!" />
            <CTestimonials name='Emily Chen, Marketing Manager' text="JustBelieveSeo has been an invaluable partner for our fashion brand. Their content marketing expertise has taken our blog to new heights, attracting more readers and engagement. The increase in organic traffic has been impressive, and we've seen a significant rise in sales as a result. JustBelieveSeo's team is proactive, communicative, and always ready to provide valuable insights. We highly recommend them for anyone serious about boosting their online presence!" />
        </div>
    </div>;
}