    ...
    return <div className='w-full p-8 py-2 bg-black text-white sm:text-base text-sm'>
        <div className='max-w-7xl m-auto flex md:flex-nowrap flex-wrap'>
            ...
            <div className='m-auto py-6 px-8 sm:ml-auto ml-0 md:w-1/3'>
                {"At JustBelieveSeo, we are dedicated to helping businesses reach new heights through exceptional SEO solutions. Our team of experts is committed to driving results and delivering excellence. Let's elevate your online presence together!"}
            </div>
        </div>
