...
export default function X() {
    ...
    return <>
        ...
        <div className='bg1 w-full'>
            <div className='max-w-7xl m-auto p-6 text-center py-12'>
                ...
                <div className='sm:text-xl text-white opacity-70 font-bold mt-4'>
                    {"Reach out to JustBelieveSeo and unlock the power of strategic SEO solutions!"}
                </div>
            </div>
        </div>
        ...
        <div className='p-6 max-w-5xl m-auto my-12'>
            ...
            <iframe className={'w-full hover:drop-shadow-lg h-[30rem] duration-300 rounded-2xl border-[1px] border-neutral-300 ' + (map ? '':'hidden')} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2957.8852511801506!2d24.78912768194104!3d42.152742287477594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14acd15ce69dc589%3A0x20c0403ddf1344c0!2sul.%20%22Vratsata%22%205%2C%2021%2C%204006%20Izgrev%2C%20Plovdiv%2C%20Bulgaria!5e0!3m2!1sen!2s!4v1692259902425!5m2!1sen!2s" width="600" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
