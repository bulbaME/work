...
export default function X() {
    return <>
                ...
                <div className='md:w-1/2 md:pr-8 text-white h-fit my-auto'>
                    <div className='my-auto py-8'>
                        ...
                        <div className='font-medium sm:text-xl mt-8'>
                            {"Are you ready to take your online business to new heights? Look no further than JustBelieveSeo! We are your one-stop destination for all your SEO needs. With our expert team of digital enthusiasts and cutting-edge strategies, we'll make sure your website reaches for the stars and shines brightly in search engine rankings."}
                        </div>
                    </div>
                    <div className='my-auto py-8'>
                        <div className='font-extrabold sm:text-3xl text-xl'>
                        ...
                        <div className='font-medium sm:text-xl mt-8'>
                            {"Don't let your online presence fade into obscurity. Partner with JustBelieveSeo and witness a digital transformation like never before. Together, we'll propel your website to reach the stars and beyond!"}
                        </div>
                    </div>
        ...
        <div className='my-16'>
            ...
            <P1L 
                title='Unveil Digital Success - Triumph with JustBelieveSeo!' 
                slogan="JustBelieveSeo's Triumph!" 
                text={[
                    ...
                    "JustBelieveSeo's strategic keyword research goes beyond identifying generic keywords. Instead, we focus on finding laser-focused keywords that align perfectly with your target audience's search intent. With this approach, you can be confident that every piece of content we create resonates with your visitors, sparking engagement and loyalty.",
            ...
            />
            <P2R 
                title='Propel your business with JustBelieveSeo'
                slogan="Guiding you on the path to triumph in the digital universe!"
                text={[
                    "Are you ready to propel your business towards unprecedented heights? JustBelieveSeo is your ultimate path to triumph in the digital universe. As your strategic partner, we take great pride in crafting a bespoke SEO strategy tailored to your unique business needs and objectives.",
