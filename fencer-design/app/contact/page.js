...
export default function Main() {
    ...
    return <>
        ...
        <div className='flex flex-wrap max-w-6xl m-auto mt-8 align-middle'>
            ...
            } title='Phone Number' descr='+83 (628) 358-6865' />
            <ContactCard img={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
            } title='E-mail' descr='support@fencer-design.com' />
            <ContactCard img={
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
        ...
        <div className='max-w-6xl m-auto p-6 flex flex-wrap-reverse mb-24'>
            ...
            <form onSubmit={() => send_mail(name, mail, product, text)} className='w-full sm:p-8 bg-white rounded-3xl text-black drop-shadow-xl h-fit min-w-[20rem]'>
                ...
                <label className='m-4 flex'>
                    ...
                    <input required className='bg-stone-200 select-none appearance-none outline-none rounded-lg p-2 mr-2 w-3/5 m-auto' value={name} onChange={(e) => Setname(e.target.value)} />
                </label>
                <label className='m-4 flex'>
                    <div className='m-2 mr-0 text-xl font-medium'>
                        Your E-mail:
                    </div>
                    <input required className='bg-stone-200 select-none appearance-none outline-none rounded-lg p-2 mr-2 w-3/5 m-auto' value={mail} onChange={(e) => Setmail(e.target.value)} />
                </label>
                <label className='m-4 flex'>
