import { Banner, BannerHome } from "./_modules/banner";
...
export default function Main() {
    return <>
        <Header page={1} />
        <BannerHome img='/img/1.jpg' />
        <div className='pt-8 lg:pt-16 min-h-screen background-1'>
        ...
        <Banner cta_route='/contact' cta='Reach us now!' img='/img/9.jpg' title={<>Ready to supercharge your online presence?</>} />
        ...
        <Banner img='/img/19.jpg' cta='Check out our offerings' cta_route='/services' title={<>Explore our services and unlock your business potential today!</>} />
        <Footer page={1} />
    </>;
}