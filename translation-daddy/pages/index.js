...
export default function X() {
    return <>
        ...
        <div className='max-w-7xl m-auto p-6 banner-main drop-shadow-lg'>
            <div className='sm:w-1/2 w-2/3 my-16'>
                ...
                <div className='sm:text-lg my-12 font-light'>
                    {"Are you looking to conquer the world with your business, but language barriers are holding you back? Look no further! Translation Daddy is your ultimate language partner, providing expert translation services to unlock the true potential of your global ventures."}
                </div>
        ...
        <WFeatures />
        <P1L img='1' title='Welcome to Translation Daddy - Your Multilingual Language Partner' text="Welcome to Translation Daddy, your trusted language partner for all your translation needs. We are dedicated to breaking down language barriers and empowering global communication. Our mission is to enable businesses and individuals to expand their horizons and connect with diverse audiences worldwide through accurate and culturally-sensitive translations. Whether you are a business looking to expand internationally or an individual seeking personal translation services, Translation Daddy is here to help you navigate the multilingual landscape with ease." />
        <P1R img='2' title='Experience the Translation Daddy Difference' text="At Translation Daddy, we go beyond just providing translations. We are passionate language enthusiasts who believe in the transformative power of communication. Our dedication to accuracy, cultural sensitivity, and customer-centricity sets us apart in the industry, making Translation Daddy your ideal language ally." />
        <WGetStarted />
        <P1L img='3' title='Why Choose Translation Daddy?' text="At Translation Daddy, we understand the significant impact that accurate and culturally-sensitive translations can have on your business or personal endeavors. Our team of skilled linguists and subject matter experts is committed to delivering the highest quality for your content. We recognize the importance of confidentiality and security, ensuring that your documents and information are safeguarded throughout the translation process. With a strong commitment to punctuality, we make it our priority to deliver your projects on time, no matter how tight the deadline." />
        <P1R img='4' title='Our Commitment to Excellence' text="At Translation Daddy, we take immense pride in delivering unparalleled translation services. Our approach revolves around precision and a deep understanding of various cultures, ensuring that your message is effectively conveyed to your target audience. Each project is handled with meticulous attention to detail, tailored to your specific needs, and designed to achieve the best possible outcomes. Your success is our success, and we strive to exceed your expectations with every translation project we undertake." />
        <P1L img='5' title='Unlock Global Opportunities' text="As the world becomes increasingly interconnected, accurate translation has become more critical than ever before. Translation Daddy opens the doors to new markets and opportunities, allowing you to reach diverse audiences around the world. Our expert team ensures that your content is not only linguistically accurate but also culturally relevant, making a lasting impact on your international customers. With Translation Daddy by your side, you can confidently communicate your message and offerings to a global audience." />        
        <WAboutSmall />
        <WServicesSmall />
