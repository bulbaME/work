...
export default function Main() {
    return <>
        ...
        <Paragraph img='/img/2.jpg' text="Captivating copy has the ability to sway hearts, change minds, and ignite action. At Fusion Copywriting, we understand the profound impact that well-crafted words can have on your business. That's why we are here to revolutionize your brand's messaging through the art of copywriting." />
        ...
        <ExpWidget />
        <Paragraph img='/img/15.jpg' text="At Fusion Copywriting, we understand the critical role that compelling copy plays in driving business growth and success. Our team of skilled copywriters is here to help you unlock the full potential of your brand through persuasive and impactful messaging." />
