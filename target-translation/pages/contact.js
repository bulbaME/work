        ...
        <div className='max-w-6xl p-8 mt-10 mb-24 m-auto'>
            ...
            <form onSubmit={() => send_form(name, mail, product, text)} className='w-full p-1 bg-white sm:p-8 bg-p-m drop-shadow-xl text-black h-fit'>
                ...
                <label className='m-4 flex'>
                    ...
                    <input required className='bg-stone-100 select-none appearance-none outline-none text-p-d p-2 px-4 mr-2 w-3/5 m-auto' value={name} onChange={(e) => Setname(e.value)} />
                </label>
                <label className='m-4 flex'>
                    <div className='m-2 mr-0 text-lg sm:text-2xl font-semibold'>
                        Your E-mail:
                    </div>
                    <input required type='email' className='bg-stone-100 select-none appearance-none outline-none text-p-d p-2 px-4 mr-2 w-3/5 m-auto' value={mail} onChange={(e) => Setmail(e.value)} />
                </label>
                <label className='m-4 flex'>
                    <div className='m-2 mr-0 w-1/3 text-lg sm:text-2xl font-semibold'>
                        Describe your needs:
                    </div>
                    <textarea className='bg-stone-100 select-none appearance-none outline-none text-p-d p-2 px-4 h-[6rem] mr-2 w-3/5 m-auto resize-none' value={text} onChange={(e) => Settext(e.value)} />
                </label>
