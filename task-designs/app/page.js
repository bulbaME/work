...
export default function Main() {
    return <>
        ...
        <div className='mt-10 w-fit m-auto'>
            <FeedbackCard img='/img/4.jpg' author='Sarah Thompson, CEO' text="I cannot recommend Task Designs highly enough! Their team of talented designers and exceptional customer service made our experience truly remarkable. They listened attentively to our needs, brought our vision to life, and delivered designs that surpassed our expectations. The attention to detail and creativity in their work is unmatched. We are thrilled with the final results and look forward to working with Task Designs on future projects." />
        </div>
        <div className='w-fit m-auto'>
            <FeedbackCard img='/img/5.jpg' author='John Anderson, Marketing Director' text="Working with Task Designs was a game-changer for our brand. Their team has an incredible ability to understand the essence of a brand and translate it into visually stunning designs. The level of professionalism, timely communication, and commitment to delivering high-quality work were truly impressive. We received numerous compliments on our new branding, all thanks to the exceptional work of Task Designs. We wholeheartedly recommend their services to anyone in need of top-notch design solutions." />
        </div>
        <div className='w-fit m-auto'>
            <FeedbackCard img='/img/6.jpg' author='Emily Roberts, Founder' text="Choosing Task Designs for our design needs was the best decision we made. From the initial consultation to the final product, their team demonstrated an unwavering dedication to excellence. Their creativity and innovative approach brought a fresh perspective to our designs, making them stand out in a competitive market. The level of professionalism, attention to detail, and seamless project management left us thoroughly impressed. We are grateful for their outstanding work and would not hesitate to work with Task Designs again in the future." />
        </div>
        <Footer />
    </>;
}