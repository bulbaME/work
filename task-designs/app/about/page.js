...
export default function Main() {
    return <>
        ...
        <Paragraph img='/img/7.jpg' title='Our Passion for Design' text="At Task Designs, we are driven by our passion for design. We believe in the power of visual communication to create meaningful connections and make a lasting impact. With our team of talented designers and creative thinkers, we are dedicated to delivering exceptional design solutions that exceed our clients' expectations." />
