    ...
    return <><div className='w-full py-2 bg-white text-b-d font-light sm:text-base text-sm drop-shadow-lg'>
        <div className='max-w-7xl m-auto'><WAppear className='flex flex-wrap'>
            ...
            <div className='m-auto py-6 md:mr-8 mr-0 md:w-1/2'>
                <div className='font-bold mb-2 text-o'>{"© 2023 OneToTranslate. All rights reserved."}</div>
                {"At OneToTranslate, we are dedicated to breaking language barriers and fostering meaningful connections through expert translation services. With a commitment to accuracy, cultural sensitivity, and seamless communication, we empower individuals and businesses to reach global audiences. "}
            </div>
